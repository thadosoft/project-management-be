...
public class DataMigrationServiceImpl implements IDataMigrationService {
  ...
  public DataMigrationServiceImpl(CaptureDatumRepository employeeRepository) {
    ...
    String url = "jdbc:sqlserver://10.11.132.101:1433;databaseName=ivms;encrypt=true;trustServerCertificate=true";
    String username = "sa";
...
//      }
    ...
    System.out.println("Dữ liệu đã được chuyển thành SQLServer thành công!");
  }
}