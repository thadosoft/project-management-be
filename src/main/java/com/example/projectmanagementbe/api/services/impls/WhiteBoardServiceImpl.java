...
public class WhiteBoardServiceImpl implements WhiteBoardService {
    ...
    public Page<WhiteBoardResponse> searchByParams(SearchWhiteBoard request, Pageable pageable) {
        ...
        return whiteBoardRepository
                .findByParams(startDate, endDate, pageable)
                .map(whiteBoardMapper::mapWhiteBoardResponse);
    }
    ...
    public void create(CreateWhiteBoard request) {
        ...
        WhiteBoard whiteBoard = whiteBoardMapper.map(request);
        whiteBoard.setEmployee(employee);
    ...
    public void update(Long id, UpdateWhiteBoard request) {
        ...
        whiteBoardMapper.update(request, whiteBoard);
        whiteBoardRepository.save(whiteBoard);
    }
    ...
    public WhiteBoardResponse findById(Long id) {
        return whiteBoardMapper.mapWhiteBoardResponse(whiteBoardRepository.findById(id)
                .orElseThrow(() -> new ApiRequestException(ErrorCode.WHITE_BOARD_NOT_FOUND)));
    }
}